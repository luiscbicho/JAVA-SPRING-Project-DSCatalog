...
public class ProductServiceIT {
    ...
    @Test
    public void findAllPagedShouldReturnPageOfProducts() throws Exception {
        PageRequest pageRequest = PageRequest.of(0, 10);
        Page<ProductWithCategoryDTO> result = service.findAllPaged(pageRequest);
    ...
    @Test
    public void findAllPagedShouldReturnSorteredPageOfProductsWhenSortByName() throws Exception {
